        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Genatarte your first Thubnail for free </span>
            ...
            >
                AI thumbnail Genatrator for your
            ...
            >
                <button onClick={()=>navigate('/genarate')} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    Genarate Now
                </button>
