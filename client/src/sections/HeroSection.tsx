    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.div
                ...
                className="mt-44"
            >
                <Link to="/generate" className="group flex items-center gap-2 rounded-full p-1 pr-3 text-pink-100 bg-pink-200/15">
            ...
            <motion.h1 className="text-5xl/17 md:text-6xl/21 font-medium max-w-3xl text-center mt-6"
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ type: "spring", stiffness: 240, damping: 70, mass: 1 }}
            >
                AI-powered Thumbnail Generator for your
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Create stunning, high-CTR YouTube thumbnails in seconds. Boost your views and click-through rates using advanced AI.
            </motion.p>
            ...
            >
                <button onClick={() => navigate('/generate')} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11 cursor-pointer transition">
                    Generate Now
                </button>
                <button 
                    onClick={() => {
                    ...
                    className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50 transition rounded-full px-6 h-11 cursor-pointer"
                >
