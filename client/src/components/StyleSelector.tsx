...
//         <label htmlFor="" className="block text-sm font-medium text-zinc-200">Tumbnail Style</label>
//         <button type="button"
//         onClick={()=>setIsOpen(!isOpen)} className="flex w-full items-center justify-between rounded-md px-4 py-3 text-left transition
...
const StyleSelector = ({
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      {isOpen && (
        <div className="absolute mt-1 w-full rounded-md border border-white/12 bg-black/20 backdrop-blur-3xl shadow-lg">
